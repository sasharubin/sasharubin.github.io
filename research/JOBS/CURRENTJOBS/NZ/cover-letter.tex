...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Hiring Committee, Department of Computer Science}{Position of Lecturer in Data Science with a focus towards Artificial Intelligence.
}
\date{October, 2017}
\opening{\vspace{-13mm}}
...
% well.)
% Artificial Intelligence including but not limited to cognitive systems, data mining, integration, knowledge representation, logic, machine learning, multi-agent systems, natural language processing, optimization, pattern recognition, planning, reasoning, robotics and perception, search, statistical learning.
% 
...
% As this letter and my CV show, my speciality is formal approaches to Artificial Intelligence, and this informs my research, supervision and teaching since 2014.
...
% My individual work is complemented by my deep integration with world-leaders in AI, including:
% experts in Knowledge Representation (Giuseppe De Giacomo), Automated Planning (Hector Geffner and Blai Bonet), Logic in Computer Science (Moshe Vardi), and Formal Methods in Multi-agent systems (Michael Wooldridge and Alessio Lomuscio). 

% 
% \emph{``[He] is an internationally highly regarded
% researcher in Formal Methods that has developed a profound interest in
% Artificial Intelligence in the last years.''} \hfill{Giuseppe De Giacomo, Sapienza Rome.}
% 
% \emph{``He is the strongest candidate that has appeared on the international job market on themes of Logic
% and Artificial Intelligence for several years...
% Over the past two years he has co-authored 10 papers in [...] the most prestigious conferences in AI. 
% I know very few people worldwide with these levels of output. All of them are experienced full professors 
% with large groups consisting of several junior researchers; none of them is a young researcher like him. 
% This is hugely impressive and a mark of the highest possible quality. ...
% A feature of Dr Rubin that I have great respect for is that
% he always seeks deep results that will make a lasting contribution to the discipline. 
% This is a mark of a true scientist; precisely those that we need today.''}
% \hfill{Alessio Lomuscio, Imperial College London}
% 
% \emph{``[He] should be an ideal candidate for an academic position at any leading	
% university, and I recommend him to	you wholeheartedly.}	\hfill{Michael Wooldridge, University of Oxford}	
...
% 's Synthesis Lectures on Distributed Computing Theory series.
