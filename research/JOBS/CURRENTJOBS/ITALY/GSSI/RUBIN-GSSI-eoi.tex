...
\begin{document}
\noindent\textsc{\LARGE {Sasha Rubin}  \hfill 3.2017} 
\newline

\noindent\textsc{\LARGE  Expression of Interest for RTD-A and RTD-B} 
...
\section{\mysidestyle Motivation Letter}


\noindent {\bf Academic Interests:}
...
explainable, i.e., as the use of AI explodes in
...
system takes the actions it does (explainable AI). My focus has been on modeling, specification and verification of
...
\noindent {\bf Projected Teaching/Supervision Activities:}
I have collaborated with a number of PhD students [26, 18, 15, 10, 4,
3], a number of undergraduate students [21,22,23], and am 
a Program Committee member for IRISA Master Research Internship 2016-2017.
I will continue to collaborate with PhD students: exciting PhD topics include
...
\noindent {\bf Projected Research Activities:}
I project two main research activities at GSSI.

I intend to investigate normal and speculative questions in Formal
Methods with application to Multi-agent Systems.\footnote{I use
...
practice.}  I plan to investigate foundational issues (modeling, verification, synthesis)
  in formal methods of parameterised/distributed systems and networks, and 
...
A second goal, building on the first, and arguably more important,
...
(MAS) communities. I recently co-organised the First Workshop on Formal 
Methods in Artificial Intelligence\footnote{\textsf{https://sites.google.com/site/fmai2017homepage/home}} 
and look forward to future editions.
...
\item[Fellow] \hfill $03.2017$ -- present\\ Fellow of the ASTREA lab,\footnote{\url{http://people.na.infn.it/~murano/}} University of Naples ``Federico II'', Italy.
...
\section{\mysidestyle {Brief Research Statement}}

I work in formal methods for artificial intelligence and multi-agent systems with a focus on foundational issues and using mathematical logic and automata theory for 
describing, reasoning about and controlling systems.
...
\def\citeKNRS04{95} % 95 in April 2017, 94 in Feb 2017, 91 in July 2016, 
\def\citeRubin08{85} % 85 in Feb 2017, 85 in Sept 2016, 84 in July 2016 
\def\citeThesis{67} % 67 in Feb 2017, 64 in August 2016
\def\citeAminofJKR14{35} % 35 in April 2017, 34 in Feb 2017, 39?? in July 2016
...
\item Games for Verification (graduate) \hfill $2017$\\
{\it University of Naples ``Federico II'', DIETI}
...
\\
\emph{Conferences}: \sc{KR, AAMAS, AAAI, EUMAS, ECAI, LICS, STACS, ICALP, MFCS, CONCUR, CSL, FoSSaCS, FSTTCS, SR, KRR@SAC, CiE, GandALF, RV, LPAR, LATA.}
\end{itemize}
...
\noindent{\bf Roderick Bloem} --- Previous Employer and Collaborator\\
Institute for Applied Information Processing and Communication, 
Technische Universit\"at Graz\\
roderick.bloem@iaik.tugraz.at\\


\noindent{\bf Aniello Murano} --- Current Employer and Collaborator\\
DIETO, 
% Dip. di Ingegneria Elettrica e Tecnologie dell'Informazione, 
Università degli Studi di Napoli ``Federico II''\\
murano@na.infn.it\\

\noindent{\bf Giuseppe De Giacomo} --- Current Collaborator \\
...
\noindent{\bf Alessio Lomuscio} --- Current Collaborator\\
...
\noindent{\bf Michael Wooldridge} --- Current Collaborator\\
Department of Computer Science, 
...
\noindent{\bf Erich Gr\"adel} --- Previous Collaborator \\
...
%\columnbreak
\noindent{\bf Frank Stephan} --- Previous Collaborator\\
School of Computing, 
...
I have 38 refereed publications including 1 (co-authored) book, 1 (sole authored) book-chapter, 8 journal articles (5 of them invited), 5 {\sc LICS} papers, 4 {\sc AAMAS} papers, 3 {\sc STACS} papers, 1 {\sc IJCAI} paper, 1 {\sc KR} paper, and a best-paper at {\sc PRIMA}. Not listed, are 6 invited journal articles (in preparation or under evaluation) and an invited chapter in a handbook on automata theory and applications (J.E. Pin (ed.), to be published by EMS).
