...
\title{Research plan 2018 -- 2021: Formal Methods for 
Automated Synthesis of Trustworthy Behaviour of Artificial Agents} 
...
\todo{lthough the ARC requirements don’t say this,
structure the first page so that it reads as an executive summary of the
proposal that conveys to a *non-expert* reader an overview of what it is about, }

\todo{Add: References in the form [CXX] [JXX] [BXX] refer to conferences, journals and books by the author, and can be found in the ``References'' section of the accompanying CV.}
...
\todo{talk about specific outcomes}
...
% \subsection{Part A}
% 
% \paragraph{Summary (100 words)}
% This document describes my 4 year research plan whose objective is to develop 
% 
% \paragraph{Benefit and Impact (100 words)}
% 
% \subsection{Part C (10 pages)}
