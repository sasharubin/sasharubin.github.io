...
\textbf{Data-aware Processes.}  \project will consider mechanisms that
...
\cite{DeVa13,DeVa15,DeVa16}. % and in \textbf{declarative business processes} \cite{AalstPS09}.
...
%: manufacturing systems (Industry 4.0),  smart spaces (IoT), and business processes (BPM).
\end{itemize}
